...
var material = new THREE.MeshBasicMaterial({ color:"maroon" });
...
const TorusK = new THREE.TorusKnotGeometry( 10, 3, 100, 16 );
...
function SetMaterial(mat){
    ...
    if (mesh){
        ...
        switch (type_material){
            case 1:
                material = new THREE.PointsMaterial({color: "maroon",size: 1.5});
                mesh = new THREE.Points(dummy_mesh.geometry,material);
                CloneMesh(dummy_mesh);
                break;
            case 2:
                material = new THREE.MeshBasicMaterial({ color: "maroon", wireframe: true });
            ...
            case 3:
                if (!light)
                    ...
                    material = new THREE.MeshPhongMaterial({ color: "maroon"});
                mesh = new THREE.Mesh(dummy_mesh.geometry, material);
                CloneMesh(dummy_mesh);
                break;
            case 4:
